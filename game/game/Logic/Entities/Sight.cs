...
namespace Game.Logic.Entities {
  ...
  public class Sight {
    ...
    private static Dictionary<SightType, Sight> s_sights = new Dictionary<SightType, Sight>();
    private const int DEFAULT_RANGE = 25;
    private const bool DEFAULT_CLOAKED = false;
    private static WasBlocked DEFAULT_BLOCKED = DefaultBlockedSight;
