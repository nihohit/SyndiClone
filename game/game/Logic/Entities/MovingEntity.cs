...
namespace Game.Logic.Entities {
  ...
  public abstract class MovingEntity : Entity {
    ...
    protected MovingEntity(int reactionTime, reactionFunction reaction, int health, EntityType type, Vector size, Affiliation loyalty, Visibility visibility, Sight sight, int speed, List<Direction> path, Direction headed) : base(reactionTime, reaction, health, type, size, loyalty) {
      Speed = speed;
      Path = path;
      m_headed = headed;
